...
post-field-report remediation and a subsequent baseline-arming recovery update are open in
[PR #8](https://github.com/nick-kuhle/darts-180/pull/8), awaiting a new direct-device retest;
