...
[PR #5](https://github.com/nick-kuhle/darts-180/pull/5). A browser-camera reliability remediation
is awaiting review and direct field validation; synthetic tests alone do not make it merge-ready.
