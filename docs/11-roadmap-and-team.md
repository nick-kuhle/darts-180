...
field-test scorer awaiting its own review; manifest validation; synthetic scenes; and inspectable
pose/temporal baselines. The specific inventory and non-claims live in
...
| --: | ---------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------------------- |
|   1 | Review camera field-test PR, assign name/legal owner, and enable CI policy         | [PR #1](https://github.com/nick-kuhle/darts-180/pull/1) is merged; field-test review, legal owner, and branch policy remain needed. |
