...
field-test scorer in [PR #2](https://github.com/nick-kuhle/darts-180/pull/2); manifest validation;
synthetic scenes; and inspectable pose/temporal baselines. The specific inventory and non-claims live in
...
| --: | ---------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
|   1 | Review camera field-test PR, assign name/legal owner, and enable CI policy         | [PR #1](https://github.com/nick-kuhle/darts-180/pull/1) is merged; [PR #2](https://github.com/nick-kuhle/darts-180/pull/2), legal owner, and branch policy remain needed. |
