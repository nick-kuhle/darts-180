...
The post-field-report browser remediation and its subsequent automatic baseline-recovery update are
open in [PR #8](https://github.com/nick-kuhle/darts-180/pull/8) and require a new direct-device
retest; their evidence taxonomy, retest procedure, and non-claims live in
