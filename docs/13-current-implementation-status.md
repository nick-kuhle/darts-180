...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| Git / delivery           | Private GitHub `main`, merged initial foundation [PR #1](https://github.com/nick-kuhle/darts-180/pull/1) and browser field-test [PR #2](https://github.com/nick-kuhle/darts-180/pull/2), open Vercel/mobile update [PR #3](https://github.com/nick-kuhle/darts-180/pull/3), CI workflow, lint/format/type/test/build commands, issue templates, contribution/security notices, root and `apps/web` Vercel configurations | Review/merge PR #3, verify its GitHub Actions result, configure branch protections/required review policy, and import only `apps/web` as the Vercel project.                                                                              |
...
1. [Initial foundation PR #1](https://github.com/nick-kuhle/darts-180/pull/1) and
   [browser Camera Score PR #2](https://github.com/nick-kuhle/darts-180/pull/2) are merged. Review
   and merge [Vercel/mobile deployment PR #3](https://github.com/nick-kuhle/darts-180/pull/3), verify
...
| 2026-09-07 | Created private-repository bootstrap `main`, merged [initial foundation PR #1](https://github.com/nick-kuhle/darts-180/pull/1) and [browser field-test PR #2](https://github.com/nick-kuhle/darts-180/pull/2), and opened the Vercel/mobile deployment update as [PR #3](https://github.com/nick-kuhle/darts-180/pull/3).     |
