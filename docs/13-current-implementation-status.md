...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------- |
| Git / delivery           | Local Git history, CI workflow, lint/format/type/test/build commands, issue templates, contribution/security notices, Vercel configuration                                                             | The private GitHub remote still needs the local `main` branch pushed and branch protections configured.                                |
...
1. Push local `main` to the private GitHub remote; enable CI, branch protection, and required review
   policy. `CODEOWNERS` temporarily points at `@nick-kuhle` until an organization/team structure
   exists.
