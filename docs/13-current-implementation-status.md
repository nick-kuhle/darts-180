...
| ------------------------ | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | -------------------------------------------------------------------------------------------------------------------------------------- |
| Git / delivery           | Private GitHub `main`, merged initial foundation [PR #1](https://github.com/nick-kuhle/darts-180/pull/1), open browser field-test [PR #2](https://github.com/nick-kuhle/darts-180/pull/2), CI workflow, lint/format/type/test/build commands, issue templates, contribution/security notices, Vercel configuration | Review/merge PR #2, verify its GitHub Actions result, and configure branch protections/required review policy.                         |
...
1. [Initial foundation PR #1](https://github.com/nick-kuhle/darts-180/pull/1) is merged. Review
   and merge [browser Camera Score PR #2](https://github.com/nick-kuhle/darts-180/pull/2), verify
...
| 2026-09-07 | Created private-repository bootstrap `main` and merged [initial foundation PR #1](https://github.com/nick-kuhle/darts-180/pull/1). The browser field-test extension is open for review in [PR #2](https://github.com/nick-kuhle/darts-180/pull/2).                                                                            |
