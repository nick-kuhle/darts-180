...
4. **Install and phone-test only the development package.** Place the reviewed ONNX + schema-1 manifest through
   ...
   explicitly labelled development retest. Normal Live Scoring will then find anchors/tips without manual
   point taps and open each proposed score for correction.
