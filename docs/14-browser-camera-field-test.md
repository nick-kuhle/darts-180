...
**Status:** browser-local experimental player flow; [PR #8](https://github.com/nick-kuhle/darts-180/pull/8) baseline-recovery update awaiting direct-device retest, September 2026
...
1. The browser field test and Vercel app-root preparation are merged in
   ...
   found dart-resolution failures. The dedicated remediation and baseline-recovery update is open in
   [PR #8](https://github.com/nick-kuhle/darts-180/pull/8); test its top-level HTTPS deployment as
   described in [`15-browser-dart-field-remediation.md`](15-browser-dart-field-remediation.md)
   before treating the heuristic as improved.
